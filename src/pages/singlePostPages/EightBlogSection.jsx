import { Box, Card, CardContent, CardHeader, Link, Stack, Typography, useTheme } from "@mui/material"
    ...
    <Stack>
          ...
          <Typography variant="body1" sx={{ mt: 3, mb: 3, lineHeight: 2 }}>
            ...
            <Link
              ...
              underline="hover"
            >
              originally introduced the different React pre-release channels
              three years ago
            </Link>
            ...
            wasn’t announced, please file a bug in the React repository so that
            we can help diagnose it. We expect that as this practice becomes
            widely adopted, it will reduce the amount of effort necessary to
            upgrade libraries to new major versions of React, since accidental
            regressions would be found as they land.
          </Typography>
        </Box>
        <Box>
          <Card
          ...
          >
            ...
            <CardContent sx={{ lineHeight: 2, pb: 3, pt: 2 }}>
              <Typography variant="body1" color="inherit">
                Strictly speaking, Canary is not a new release channel—it used
                to be called Next. However, we’ve decided to rename it to avoid
